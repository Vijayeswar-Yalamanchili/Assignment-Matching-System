            ...
            getLoginToken === null ? <>
                <div className="w-full max-w-sm m-auto my-20">
                    <form className="bg-white outline outline-stone-300 rounded-3xl p-12 mb-4" onSubmit={formik.handleSubmit}>
                        ...
                        <div className='text-center mt-3 text-lg'><Link to={'/register'} className="inline-block align-baseline text-sm text-blue-500 hover:text-blue-800">New User? Register</Link></div>
                    </form>
                </div>
            </> : <>
